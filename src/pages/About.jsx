  ...
  return (
    <section className="py-20 relative bg-white-500 overflow-hidden">
      ...
      <div className="container mx-auto bg-white-500 text-center space-y-6 relative z-10">
        ...
        >
          <motion.a
            href="https://leetcode.com/u/guru_04/" target="_blank"
            rel="noreferrer"
          ...
          <motion.a
            href="https://github.com/guru242" target="_blank"
            rel="noreferrer"
            className="text-4xl hover:text-yellow-500 transition duration-300"
            whileHover={{ scale: 1.2 }}
          >
          ...
          <motion.a
            href="www.linkedin.com/in/guruprasath-m-65200a326" target="_blank"
            rel="noreferrer"
            className="text-4xl hover:text-yellow-500 transition duration-300"
            whileHover={{ scale: 1.2 }}
          >
          ...
          <motion.a
            href="https://linktr.ee/guruprasath_m" target="_blank"
            rel="noreferrer"
            className="text-4xl hover:text-yellow-500 transition duration-300"
            whileHover={{ scale: 1.2 }}
          >
        ...
        <a
  href="https://drive.google.com/file/d/1u4l9frX0baQjWOy-mTRXl911W0nCeJAj/view?usp=sharing"
  target="_blank"
  rel="noreferrer"
