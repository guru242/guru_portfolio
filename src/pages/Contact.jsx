...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_7awp9of",  // Replace with your EmailJS service ID
        "template_ifw3xkb",  // Replace with your EmailJS template ID
        formData,
        "q6553EzMktzAblCVr",       // Replace with your EmailJS public key
      )
      .then(
        (response) => {
...
<section className="contact-section py-20 ">
  <div className="container mx-auto text-center">
    ...
    <p className="text-lg text-white mb-6">For further inquiries, visit my profile at _S. You can find detailed information about my work, skills, and contact details there. Looking forward to connecting with you!</p> */}

    <div className="flex flex-wrap justify-between">
      {/* Left Side - Contact Details */}
      <div className="w-full sm:w-1/2 p-6 text-white">
        <h3 className="text-2xl font-semibold mb-6">Contact Details</h3>
        <p className="flex items-center mb-4"><UserOutlined className="mr-2" /> Name: Guru prasath M </p>
        <p className="flex items-center mb-4"><HomeOutlined className="mr-2" /> Location: Chennai -600026</p>
        <p className="flex items-center mb-4"><MailOutlined className="mr-2" /> Email: grprasath2424@gmail.com</p>
      </div>
