  ...
  return (
    <div>
      ...
      <div id="home" className="relative h-screen flex items-center justify-center text-white text-center font-sans overflow-hidden">
        ...
        <div>
          ...
          <motion.div className="flex justify-center space-x-6 mb-6" initial="hidden" animate="visible" variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 } }} transition={{ duration: 1, delayChildren: 0.5, staggerChildren: 0.2 }}>
            <motion.a href="https://leetcode.com/u/guru_04/" target="_blank" rel="noreferrer" className="text-2xl hover:text-yellow-500 transition duration-300" whileHover={{ scale: 1.2 }}><SiLeetcode /></motion.a>
            <motion.a href="https://github.com/guru242" target="_blank" rel="noreferrer" className="text-2xl hover:text-yellow-500 transition duration-300" whileHover={{ scale: 1.2 }}><FaGithub /></motion.a>
            <motion.a href="www.linkedin.com/in/guruprasath-m-65200a326" target="_blank" rel="noreferrer" className="text-2xl hover:text-yellow-500 transition duration-300" whileHover={{ scale: 1.2 }}><FaLinkedin /></motion.a>
            <motion.a href="https://linktr.ee/guru_m" target="_blank" rel="noreferrer" className="text-2xl hover:text-yellow-500 transition duration-300" whileHover={{ scale: 1.2 }}><FaLink /></motion.a>
          </motion.div>
          <motion.a href="https://drive.google.com/file/d/1u4l9frX0baQjWOy-mTRXl911W0nCeJAj/view?usp=sharing" download className="px-6 py-2 bg-blue-600 hover:bg-blue-800 text-white rounded-md text-lg transition duration-300" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1 }} whileHover={{ scale: 1.1 }}>
            Download CV
          </motion.a>
        </div>
      </div>
      ...
      <footer className="bg-gray-800 text-white  py-8 text-center">
        ...
        <p className="text-lg mt-3">Developed by Guru_prasath</p>
      </footer>
